...
$.get("/api", function(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    wellSection.attr("id", "review-well-" + i);
    ...
    // make the name an h2,
    $("#review-well-" + i).append("<h2>" + data[i].city + "</h2>");
    // the role an h3,
    $("#review-well-" + i).append("<h3>Hotel: " + data[i].hotel + "</h4>");
    // the age an h3,
    $("#review-well-" + i).append("<h3>Rating: " + data[i].rating + "</h4>");
    // and the forcepoints an h3.
    $("#review-well-" + i).append("<h3>Comments: " + data[i].comments + "</h4>");
  }
});
